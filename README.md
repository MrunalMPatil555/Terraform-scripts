...
This repository contains simple Terraform configurations to provision resources on AWS. Terraform is used as Infrastructure as Code (IaC) to automate the creation, modification, and management of cloud infrastructure.
